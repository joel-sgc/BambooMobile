...
export default function ExternalSpool({ tray, divided }: { tray: AmsTray; divided: boolean }) {
  return (
    <div className={`flex items-center gap-4 ${divided ? 'pt-4 border-t border-zinc-700/60' : ''}`}>
      <div
      ...
      <div className='flex flex-col gap-0.5 min-w-0'>
        ...
        <span className='text-white font-semibold text-sm'>{tray.tray_type}</span>
        {tray.name && (
